...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/search?q=react" style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/hnorzagaray" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@" style={ { color: colorPrimary } }><i className="fab fa-medium"></i></a>
        <a className="devto" target="_blank" rel="noopener noreferrer" href="https://dev.to/">
